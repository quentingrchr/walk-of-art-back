 ...
 */
final class Version20220608122022 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE SEQUENCE exhibition_statut_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        ...
        $this->addSql('CREATE TABLE board (id INT NOT NULL, gallery_id INT DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, orientation VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE exhibition_statut (id INT NOT NULL, exhibition_id INT NOT NULL, status VARCHAR(255) NOT NULL, decription VARCHAR(255) DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE exhibition_statut_user (exhibition_statut_id INT NOT NULL, user_id INT NOT NULL, PRIMARY KEY(exhibition_statut_id, user_id))');
        ...
        $this->addSql('CREATE TABLE gallery (id INT NOT NULL, created_user_id INT NOT NULL, name VARCHAR(255) NOT NULL, gps_lat NUMERIC(8, 6) NOT NULL, gps_long NUMERIC(9, 6) NOT NULL, price NUMERIC(5, 2) NOT NULL, max_days INT DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE reservation (id INT NOT NULL, exhibition_id INT NOT NULL, date_start DATE NOT NULL, duration INT NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP SEQUENCE exhibition_statut_id_seq CASCADE');
