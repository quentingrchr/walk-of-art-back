 ...
 */
final class Version20220708154848 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE exhibition (id UUID NOT NULL, revision_id UUID DEFAULT NULL, user_id UUID NOT NULL, work_id UUID NOT NULL, title VARCHAR(255) NOT NULL, description TEXT DEFAULT NULL, reaction BOOLEAN NOT NULL, comment BOOLEAN NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE gallery (id UUID NOT NULL, user_id UUID NOT NULL, name VARCHAR(255) NOT NULL, latitude DOUBLE PRECISION NOT NULL, longitude DOUBLE PRECISION NOT NULL, price NUMERIC(5, 2) NOT NULL, max_days INT DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE reservation (id UUID NOT NULL, exhibition_id UUID NOT NULL, date_start DATE NOT NULL, date_end DATE NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE work (id UUID NOT NULL, user_id UUID NOT NULL, main_file_id UUID DEFAULT NULL, title VARCHAR(255) NOT NULL, description TEXT DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE work_files (id UUID NOT NULL, work_id UUID NOT NULL, path_file VARCHAR(255) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
